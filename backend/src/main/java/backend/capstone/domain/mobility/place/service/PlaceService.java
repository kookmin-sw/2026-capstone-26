package backend.capstone.domain.mobility.place.service;
...
import backend.capstone.domain.mobility.place.dto.PlaceAddRequest;
import backend.capstone.domain.mobility.place.dto.PlaceAddResponse;
import backend.capstone.domain.mobility.place.dto.PlaceReorderRequest;
import backend.capstone.domain.mobility.place.dto.PlaceUpdateRequest;
import backend.capstone.domain.mobility.place.dto.PlaceUpdateResponse;
import backend.capstone.domain.mobility.place.entity.Place;
import backend.capstone.domain.mobility.place.exception.PlaceErrorCode;
import backend.capstone.domain.mobility.place.mapper.PlaceMapper;
import backend.capstone.domain.mobility.place.repository.PlaceRepository;
import backend.capstone.global.exception.BusinessException;
import backend.capstone.integration.kakao.local.dto.SearchResultByCategoryAndCoord;
...
public class PlaceService {
    ...
    public Place saveAutoPlace(
        ...
        Place place = searchResult
            ...
            .orElseGet(
                () -> PlaceMapper.toUnknownAuto(dayRoute, stay.getCenterLatitude(),
                    stay.getCenterLongitude(), newOrder,
                    stay.getStartTime(), stay.getLastTime()));
