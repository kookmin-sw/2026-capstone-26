package backend.capstone.domain.mobility.analysis.ongoingstay.service;
...
import backend.capstone.integration.kakao.local.service.KakaoSearchByCategoryService;
